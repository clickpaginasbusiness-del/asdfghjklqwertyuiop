...
/** Parceira tem acesso Pro liberado pelo cargo, mesmo sem plano='pro' sincronizado — usa isso em vez do campo `plano` cru em qualquer lugar que decide o que é feature paga. Mantém o mesmo nível de benefício histórico (Pro), não o topo da tabela — cargo de parceira nunca foi pensado como "Studio grátis". */
